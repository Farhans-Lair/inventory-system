...
// Production base path — assets load from /mfe/stock/ when built
const isProd = process.env.NODE_ENV === 'production'


export default defineConfig({
  base: isProd ? '/mfe/stock/' : '/',
  plugins: [
    react(),
    federation({
      name: 'stock-mfe',
      filename: 'remoteEntry.js',
      exposes: { './StockPage': './src/StockPage.jsx', './MovementsPage': './src/MovementsPage.jsx' },
      shared: {

...
public class StockService {
    ...
    public StockMovementResponse recordMovement(StockMovementRequest req, String performedBy) {
        ...
        switch (req.getType()) {
            ...
            case OUTBOUND -> {
                ...
                int available = level.getQuantity()
                        - reservationRepository.sumActiveReservations(product.getId(), from.getId());
    ...
    public StockReservationDto releaseReservation(String id) {
        StockReservation res = reservationRepository.findById(id)
    ...
    // ── Demand forecasting (7-day moving average of outbound qty) ─────────
    public Map<String, Object> getDemandForecast(String productId) {
        ...
        if (outbound.isEmpty()) return Map.of("productId", productId, "avgDailyDemand", 0, "forecastDays", 30, "forecastedDemand", 0);
        ...
        int daysOfStockLeft = avgDaily > 0 ? (int) (currentStock / avgDaily) : 9999;
        ...
        return Map.of(
                ...
                "reorderSuggested", daysOfStockLeft < 14
        );
    }
    ...
    private StockLevelDto toLevelDto(StockLevel sl) {
        ...
        return StockLevelDto.builder()
                ...
                .quantity(sl.getQuantity()).minQuantity(sl.getMinQuantity())
                .maxQuantity(sl.getMaxQuantity())
                .reservedQuantity(reserved)
                .availableQuantity(sl.getQuantity() - reserved)
                .lowStock(sl.isLowStock()).outOfStock(sl.isOutOfStock())
                .overstock(sl.isOverstock())
    ...
    private StockReservationDto toReservationDto(StockReservation r) {
        return StockReservationDto.builder()
                ...
                .status(r.getStatus()).createdAt(r.getCreatedAt()).expiresAt(r.getExpiresAt())
                .build();
    }
}
